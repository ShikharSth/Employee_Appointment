...
INSERT INTO `Employee` (`emp_id`, `emp_name`, `emp_phone`, `emp_role`, `emp_address`, `emp_department`, `emp_pass`, `emp_presence`, `emp_availability`) VALUES
(3, 'Rec1', '1133224411', 'receptionist', 'KTM', 'Reception', 'rec1', 1, 1),
(4, 'emp1', '2233441188', 'employee', 'BKT', 'Production', 'emp1', 0, 0),
(5, 'emp2', '1188996522', 'employee', 'KTM', 'Sales', 'emp2', 0, 0);
